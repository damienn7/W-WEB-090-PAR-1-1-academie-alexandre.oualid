...
<body>
    <header class="header-container-home">
        <div class="container">
            <div class="row">
                <a href="#" id="home"><img src="../public/img/twitter_logo.png" alt="logo de twitter" id="oiseaulogo"
                        class="logos navbar"></a>
            </div>
            <div class="row">
            ...
            <div class="row">
                <a href="#" id="explore"><img src="../public/img/hashtag.png" alt="logo hashtag"
                        class="logos"><span>Explorer</span></a>
            </div>
            <div class="row">
