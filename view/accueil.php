<body class="container container-fluid">
    ...
    <div class="row container-fluid">
        ...
        <main class="col-5 middle blur logout">
            <h2>Accueil</h2>
                    ...
                    <div class="modal-content">
                        <form action="./" method="POST" id="register_account">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-danger" id="close" data-dismiss="modal">Fermer</button>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="./" method="POST" id="login_account">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-danger" id="closed" data-dismiss="modal">Fermer</button>
            ...
            <div class="banner blur">
                <div class="login container-fluid row">
                    <div class="btn-justify">
                        <div class="col-2">
                            <button class="btn-1" id="login2" name="login" data-toggle="modal"
                            data-target="#login-modal">Connexion</button>
                        </div>
                        <div class="col-2">
                            <button class="btn-2" id="register2" name="register" data-toggle="modal"
                            data-target="#register-modal">Inscription</button>
                        </div>
                    </div>
                </div>
